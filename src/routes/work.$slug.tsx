      ...
      {project.vimeoId ? (
        <div className="mx-auto max-w-[1800px] px-6 md:px-10">
          <div className="relative aspect-video overflow-hidden bg-black">
            <iframe
              src={`https://player.vimeo.com/video/${project.vimeoId}${project.vimeoHash ? `/${project.vimeoHash}` : ""}?title=0&byline=0&portrait=0${project.vimeoAutoplay ? "&autoplay=1&loop=1&muted=1&background=1&autopause=0" : ""}`}
